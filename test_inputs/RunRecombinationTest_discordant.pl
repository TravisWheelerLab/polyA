...
my @files = <"/Users/kaitlincarey/Desktop/NOTEBOOK/2020/DiscordantPaper/Aug3-RecombinationPlot/ALIGN_DISCORDANT/*.format">;
#my @files = <"/Users/kaitlincarey/Desktop/NOTEBOOK/2020/DiscordantPaper/Aug3-RecombinationPlot/TEST/*.format">;
...
foreach my $file (@files) {
    ...
    my $SD_num;
    if($file =~ /ALIGN_DISCORDANT\/(\d+)_.+format/g){
