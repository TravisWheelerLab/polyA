...
## ---------
 ...
 python3 AdjudicateRegions.py --seqpos --lambda .1227 ex5_hg38_composite.align.format 25p41g_edited.matrix
#--heatmap support.txt --viz outfile.soda

# echo ""
#python3 AdjudicateRegions.py --seqpos --lambda .1227 ex2_hg38_nesting.align.format 25p41g_edited.matrix | tee python-output.txt


# for f in *.align.format ;
# 	do echo $f;
# 		python3 AdjudicateRegions_test.py --seqpos --lambda .1227 $f 25p41g_edited.matrix;
# 		echo "-------------------------------------------------------------\n";
# 	done
